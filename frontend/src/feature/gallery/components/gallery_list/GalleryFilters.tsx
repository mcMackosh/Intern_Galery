...
import { GalleryOrderBy, GallerySortBy } from '@/types/gallery';
...
export default function GalleryFilters() {
    ...
    const [orderBy, setOrderBy] = useState<GalleryOrderBy>(
    ...
    return (
        <section className="relative z-30 rounded-2xl bg-white/80 backdrop-blur-md border border-gray-200 shadow-lg p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4">
                ...
                <Button data-testid="apply-filters" onClick={applyFilters} className="flex items-center gap-2">
                    <Check size={16} />
                    Apply
                </Button>
            </div>
