...
// Мокаємо хук useRegisterMutation
...
describe("RegisterForm", () => {
  ...
  it("рендерить всі інпути та кнопку", () => {
    render(<RegisterForm />);
  ...
  it("викликає registration з правильними даними при сабміті", async () => {
    render(<RegisterForm />);
  ...
  it("дезейблить всі інпути та кнопку під час isLoading", () => {
    (useRegisterMutation as jest.Mock).mockReturnValue({
      registration: mockRegistration,
      isLoading: true,
    });
